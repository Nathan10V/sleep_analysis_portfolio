...
First, I wanted to see if my sleep quality varies significantly by the day of the week.
...
cor_data <- sleep |>  
  select(sleep_quality, regularity, deep_sleep_hours, total_sleep_hours, time_in_bed_hours, 
         movements_per_hour, steps, dream_seconds, light_seconds) |> 
...
## 3. Statistical Model
I am running a Linear Regression to quantify the impact of steps and bedtime duration on my overall quality score.

```{r model}
# Build a simple linear model
model <- lm(sleep_quality ~ steps + total_sleep_hours, data = sleep)
